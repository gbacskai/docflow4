...
// Note: DynamoDB table names are auto-generated by Amplify
// Pattern: ModelName-{AppSyncId}-{EnvSuffix} 
// Custom tables in custom-resources use: docflow4-{TableName}-{envName}
console.log('📋 GraphQL table names will be auto-generated by Amplify with environment suffix');
...
backend.addOutput({
  custom: {
    ...
    appName: 'docflow4',
    tableNamingPattern: 'ModelName-{AppSyncId}-{envSuffix}'
  }
});